    ...
    <section>
        ...
        <main class="px-8 py-6 bg-gray-100">
            <div class="max-w-7xl mx-auto grid grid-cols-4 gap-4">
                ...
                <div class="main-center col-span-2 space-y-4">
                    <div class="bg-white border border-gray-200 rounded-lg">
                        ...
                        <div class="p-4 border-t border-gray-100 flex justify-between">
                            ...
                            <a href="#" class="inline-block py-4 px-6 bg-lime-500 rounded-md text-white ">Post</a>
                        </div>
                    </div>
                    ...
                    <div class="p-4 bg-white border border-gray-200 rounded-lg">
                        <div class="mb-6 flex items-center justify-between">
                            <div class="flex items-center space-x-6">
                                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTIDkATaMJuWJtFtBuKmBjktirW2E0RjdsA5g&s" alt="" class="w-12 h-12 rounded-full">
                        ...
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTIDkATaMJuWJtFtBuKmBjktirW2E0RjdsA5g&s" alt="" class="w-full  rounded-lg">
                ...
                <!-- People You May Know Code Start Here -->
                    ...
                    <div class="p-4 bg-white border border-gray-200 rounded-lg">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center justify-between">
                                ...
                                <a href="#" class="py-2 px-3 bg-lime-500 rounded-md text-white text-xs ">Show</a>
                            </div>
                    ...
                    <div class="p-4 bg-white border border-gray-200 rounded-lg">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center justify-between">
                                ...
                                <a href="#" class="py-2 px-3 bg-lime-500 text-white text-xs rounded-md">Explore</a>
                            </div>

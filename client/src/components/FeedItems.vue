<template>
   <section>
        ...
        <div class="flex items-center space-x-6">
            ...
            <p>
                <strong>
                    <a to="#"> Post Creator Name</a>
                </strong>
            </p>
        </div>

        <p class="text-gray-600">ago</p>
    </div>
    ...
    <div class="my-6 flex justify-between">
        <div class="flex space-x-6 items-center">
            <div class="flex items-center space-x-2" >
                ...
                <span class="text-gray-500 text-xs"> Likes Count likes</span>
            </div>
            ...
            <div class="flex items-center space-x-2">
                ...
                <a  href="#" class="text-gray-500 text-xs"> 25343 comments</a>
            </div>
